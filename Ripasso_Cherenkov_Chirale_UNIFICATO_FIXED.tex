...
\begin{equation}
f(\vb{x},\vb{x}';\w)\simeq\frac{1}{8\pi r}\sum_{\eta=\pm}\frac{e^{i k_{0}\, \Ceta(\theta)\,r}}{g_{\eta}(\theta)},
\qquad (r\to\infty).
\end{equation}
...
\end{equation}
dove $\Kt_\eta=\Tt_{1;\eta}/\gt_\eta^2$. Definizioni operative (utili per i conti):
\begin{align}
