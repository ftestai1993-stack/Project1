...
\begin{equation}
R_{\eta}=
\frac{1}{4}\,\frac{1}{1-\dfrac{c^{2}}{n^{2}v^{2}}}
\Biggl[\frac{\sin\theta\;\tilde{K}_{\eta}(\w,\theta)}{\bigl|\sin\theta\,\tilde{C}_{\eta}(\theta)-\cos\theta\,\partial_{\theta}\tilde{C}_{\eta}(\theta)\bigr|}\Biggr]_{\theta=\theta_{\eta}}.
\end{equation}
Il rapporto tra i coni è
\frac{R_{-}}{R_{+}}=\frac{\sin\theta_{-}\,\tilde{K}_{-}(\w,\theta_{-})}{\sin\theta_{+}\,\tilde{K}_{+}(\w,\theta_{+})}\cdot
\frac{\bigl|\sin\theta\,\tilde{C}_{+}-\cos\theta\,\partial_{\theta}\tilde{C}_{+}\bigr|_{\theta=\theta_{+}}}{\bigl|\sin\theta\,\tilde{C}_{-}-\cos\theta\,\partial_{\theta}\tilde{C}_{-}\bigr|_{\theta=\theta_{-}}}.

{R\_eta} e \texorpdfstring{$R_-/R_+$}{R-/R+}}
